...
"""def cmp_str(str1,str2):
    print [(str1[i]) for i in range(len(str1))]
    print [id(str1[i]) for i in range(len(str1))]
    print [(str2[i]) for i in range(len(str2))]
    print [id(str2[i]) for i in range(len(str2))]
    return sum([id(str1[i]) for i in range(len(str1))])==sum([id(str2[i]) for i in range(len(str2))]) 
"""
class neuron:
